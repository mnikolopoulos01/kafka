...
async function debugTopics() {
  ...
  try {
    ...
    console.log("📡 Kafka broker:", defaultKafkaConfig.connectionConfig.brokers);
    ...
    if (error.message?.includes('ECONNREFUSED')) {
      ...
      console.log("   2. Broker address is correct:", defaultKafkaConfig.connectionConfig.brokers);
